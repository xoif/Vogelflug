...
public class Wand {
	...
	private Rect sourceLeft, source2Left, source3Left, sourceRight, 
	source2Right, source3Right, destineLeft, destineRight;

	public Wand (Bitmap WallLeft,Bitmap WallRight, GameView gameView) {
